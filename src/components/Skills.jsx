  ...
  return (
    <div className=''>
        <div className='w-full flex flex-col bg-white'>
            ...
            <div className="w-full relative sm:text-xl text-sm grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-1 font-light bg-tertiary p-1">
            <ExtendLine />
                ...
                // </div>
                        <div key={index} className='flex max-sm:flex-col-reverse sm:min-w-[200px] min-w-[100px] max-sm:h-24 sm:p-8 sm:justify-between justify-center items-center gap-2 bg-white outline outline-line rounded-sm'>
                            <div className='sm:h-full'>
                                ...
                                <p className='text-sm mt-2 max-sm:hidden'>{logo.exp}</p>
                            </div>
